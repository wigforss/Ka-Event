...
public class KeywordSwitchAnnotationConfigurer {
    ...
    private void setCaseMethods() {
        ...
        Set<Method> caseMethods = ReflectionUtils.getAnnotatedMethods(listenerClass, KeywordCase.class);
    ...
    private void setKeywordMethod() {
        Method method = ReflectionUtils.getAnnotatedMethod(eventClass, EventKeyword.class);
        if(method == null) {
    ...
    private void setCustomKeywordMethods() {
        Map<String, Method> methodMap = new HashMap<String, Method>();
        Set<Method> customCaseMethods = ReflectionUtils.getInheritlyAnnotatedMethods(listenerClass, CustomCase.class);
